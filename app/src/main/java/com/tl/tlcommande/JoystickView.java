...
public class JoystickView extends View
    ...
    */
    ...
    /**
     * Default half-joystick to false
     */
    private static final boolean DEFAULT_HALF_JOYSTICK = false;
    ...
    * Detect if joystick has been pressed, even if strength and angle are 0
    ...
    public JoystickView(Context context, AttributeSet attrs) {
        ...
        mPaintText.setColor(ContextCompat.getColor(context,R.color.blanc));
        mPaintText.setTypeface(ResourcesCompat.getFont(context, R.font.audiowide));
    ...
    private int getAngle() {
        if(mCenterY != mPosY || mPosX != mCenterX){
